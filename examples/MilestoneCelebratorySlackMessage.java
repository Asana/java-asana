...
public class MilestoneCelebratorySlackMessage {
    public static void main(String[] args) throws Exception {
        ...
        // Attempt to get previous sync token.
        File syncFile = new File("asana_sync_token_for_project_" + projectId);

        // If the file does not exist, we fetch a new one.
        ...
        // Pass through list of events and find stories of completing milestones.
    ...
    private static void notifySlack(SlackClient slackClient, String taskName) {
    	...
    	try {
	    	slackClient.postMessage(ChatPostMessageParams.builder()
	            .setText(message)
	            .setChannelId("#asana-notifications")
	            .build()
	    	);
    	} catch(Exception e) {
