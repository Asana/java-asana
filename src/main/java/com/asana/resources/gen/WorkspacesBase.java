...
import java.util.List;
    ...
    */
    public WorkspacesBase(Client client) { super(client); }
        ...
        */
        public ItemRequest<JsonElement> addUserForWorkspace(String workspaceGid, List<String> optFields, Boolean optPretty) throws IOException {
        ...
        public ItemRequest<JsonElement> addUserForWorkspace(String workspaceGid) throws IOException {
