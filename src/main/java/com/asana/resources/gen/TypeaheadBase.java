...
public class TypeaheadBase extends Resource {
    ...
    */
     ...
     * @param resourceType The type of values the typeahead should return. You can choose from one of the following: &#x60;custom_field&#x60;, &#x60;project&#x60;, &#x60;tag&#x60;, &#x60;task&#x60;, and &#x60;user&#x60;. Note that unlike in the names of endpoints, the types listed here are in singular form (e.g. &#x60;task&#x60;). Using multiple types is not yet supported. (required)
     ...
     */
    public CollectionRequest<AsanaNamedResource> typeaheadForWorkspace(String workspaceGid, String resourceType, String type, String query, Integer count, List<String> optFields, Boolean optPretty) throws IOException {
    ...
    public CollectionRequest<AsanaNamedResource> typeaheadForWorkspace(String workspaceGid, String resourceType, String type, String query, Integer count) throws IOException {
        return typeaheadForWorkspace(workspaceGid, resourceType, type, query, count, null, false);
    }
