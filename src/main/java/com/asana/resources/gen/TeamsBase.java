...
import java.util.List;
    ...
    */
    public TeamsBase(Client client) { super(client); }
        ...
        * @throws IOException If we fail to call the API, e.g. server error or cannot deserialize the response body
        */
        public CollectionRequest<Team> getTeamsForWorkspace(String workspaceGid, String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
            String path = "/workspaces/{workspace_gid}/teams".replace("{workspace_gid}", workspaceGid);
        ...
        public CollectionRequest<Team> getTeamsForWorkspace(String workspaceGid) throws IOException {
            return getTeamsForWorkspace(workspaceGid, null, (int)Client.DEFAULTS.get("page_size"), null, false);
        }
        /**
        ...
        * @throws IOException If we fail to call the API, e.g. server error or cannot deserialize the response body
        */
        public ItemRequest<Team> updateTeam(String offset, Integer limit, List<String> optFields, Boolean optPretty) throws IOException {
            String path = "/teams";

            ItemRequest<Team> req = new ItemRequest<Team>(this, Team.class, path, "PUT")
                .query("opt_pretty", optPretty)
                .query("opt_fields", optFields)
                .query("limit", limit)
                .query("offset", offset);
        ...
        public ItemRequest<Team> updateTeam() throws IOException {
            return updateTeam(null, (int)Client.DEFAULTS.get("page_size"), null, false);
        }
    }
