...
public class JobsBase extends Resource {
    ...
    */
     ...
     */
    public ItemRequest<JobResponse> getJob(String jobGid, List<String> optFields, Boolean optPretty) throws IOException {
        String path = "/jobs/{job_gid}".replace("{job_gid}", jobGid);

        ItemRequest<JobResponse> req = new ItemRequest<JobResponse>(this, JobResponse.class, path, "GET")
    ...
    public ItemRequest<JobResponse> getJob(String jobGid) throws IOException {
