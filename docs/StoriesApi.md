...
# **createStoryForTask**
> InlineResponse20030 createStoryForTask(body, taskGid, optPretty, optFields)
...
//import com.asana.resources.gen.StoriesApi;
...
TaskGidStoriesBody body = new TaskGidStoriesBody(); // TaskGidStoriesBody | The story to create.
...
try {
    InlineResponse20030 result = apiInstance.createStoryForTask(body, taskGid, optPretty, optFields);
...
List<String> optFields = Arrays.asList("optFields_example"); // List<String> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options.
try {
    InlineResponse2001 result = apiInstance.deleteStory(storyGid, optPretty, optFields);
    System.out.println(result);
} catch (ApiException e) {
...
# **getStoriesForTask**
> InlineResponse20031 getStoriesForTask(taskGid, optPretty, optFields, limit, offset)
...
try {
    InlineResponse20031 result = apiInstance.getStoriesForTask(taskGid, optPretty, optFields, limit, offset);
    System.out.println(result);
} catch (ApiException e) {
...
<a name="getStory"></a>
# **getStory**
> InlineResponse20030 getStory(storyGid, optPretty, optFields, limit, offset)
...
String offset = "offset_example"; // String | Offset token. An offset to the next page returned by the API. A pagination request will return an offset token, which can be used as an input parameter to the next request. If an offset is not passed in, the API will return the first page of results. 'Note: You can only pass in an offset that was returned to you via a previously paginated request.'
try {
    InlineResponse20030 result = apiInstance.getStory(storyGid, optPretty, optFields, limit, offset);
    System.out.println(result);
} catch (ApiException e) {
...
# **updateStory**
> InlineResponse20030 updateStory(body, storyGid, optPretty, optFields)
...
StoriesApi apiInstance = new StoriesApi();
StoriesStoryGidBody body = new StoriesStoryGidBody(); // StoriesStoryGidBody | The comment story to update.
String storyGid = "storyGid_example"; // String | Globally unique identifier for the story.
Boolean optPretty = true; // Boolean | Provides “pretty” output. Provides the response in a “pretty” format. In the case of JSON this means doing proper line breaking and indentation to make it readable. This will take extra time and increase the response size so it is advisable only to use this during debugging.
List<String> optFields = Arrays.asList("optFields_example"); // List<String> | Defines fields to return. Some requests return *compact* representations of objects in order to conserve resources and complete the request more efficiently. Other times requests return more information than you may need. This option allows you to list the exact set of fields that the API should be sure to return for the objects. The field names should be provided as paths, described below. The id of included objects will always be returned, regardless of the field options.
try {
    InlineResponse20030 result = apiInstance.updateStory(body, storyGid, optPretty, optFields);
    System.out.println(result);
} catch (ApiException e) {
