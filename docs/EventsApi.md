...
<a name="getEvents"></a>
# **getEvents**
> InlineResponse2007 getEvents(resource, sync, optPretty, optFields)
...
//import com.asana.resources.gen.EventsApi;
...
try {
    InlineResponse2007 result = apiInstance.getEvents(resource, sync, optPretty, optFields);
