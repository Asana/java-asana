...
> InlineResponse2005 getCustomFieldSettingsForPortfolio(portfolioGid, optPretty, optFields, limit, offset)
...
//import com.asana.resources.gen.CustomFieldSettingsApi;
...
CustomFieldSettingsApi apiInstance = new CustomFieldSettingsApi();
...
try {
    InlineResponse2005 result = apiInstance.getCustomFieldSettingsForPortfolio(portfolioGid, optPretty, optFields, limit, offset);
...
> InlineResponse2005 getCustomFieldSettingsForProject(projectGid, optPretty, optFields, limit, offset)
...
String offset = "offset_example"; // String | Offset token. An offset to the next page returned by the API. A pagination request will return an offset token, which can be used as an input parameter to the next request. If an offset is not passed in, the API will return the first page of results. 'Note: You can only pass in an offset that was returned to you via a previously paginated request.'
try {
    InlineResponse2005 result = apiInstance.getCustomFieldSettingsForProject(projectGid, optPretty, optFields, limit, offset);
    System.out.println(result);
} catch (ApiException e) {
